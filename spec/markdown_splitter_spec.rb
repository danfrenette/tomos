...
RSpec.describe Tomos::Markdown do
  ...
  describe ".count_tokens" do
    it "returns an Integer for non-empty input" do
      expect(described_class.count_tokens("# Hello\n\nWorld", model: "gpt-4")).to be_a(Integer)
    end

    it "returns a positive count for non-empty input" do
      expect(described_class.count_tokens("# Hello\n\nWorld", model: "gpt-4")).to be > 0
    end
  ...
  describe "#count_tokens" do
    it "returns an Integer for non-empty input" do
      expect(splitter.count_tokens("# Hello\n\nWorld")).to be_a(Integer)
    end
